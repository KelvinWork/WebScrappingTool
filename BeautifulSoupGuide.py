...
#result = requests.get("https://www.lazada.sg/products/prism-x240-1200r-24-144hz-1ms-curved-fhd-1920-x-1080-freesync-g-sync-ready-gaming-monitor-i225440820-s449843155.html?spm=a2o42.searchlist.list.1.99ed1b21etK8ej&search=1")
resultWeb = requests.get("https://shopee.sg/Xiaomi-Mi-Curve-Display-34-inch-Gaming-Monitor-WQHD-1500R-View-144Hz-Flicker-Free-AMD-Freesync-(1-Year-Warranty)-i.303634117.4654892453")
#rc = result.content
...
result = requests.get(resultWeb, headers= headers)
src = result.content
soup = BeautifulSoup(src, 'lxml')
print(soup.prettify())
